...
\runningheadrule{}
\firstpageheader{CS 336}{Assignment 5}{}
\runningheader{CS 336} {Assignment 5} {Page \thepage\ of \numpages}
...
\newcommand{\hmwkTitle}{Alignment and Reasoning RL} % Assignment title
\newcommand{\hmwkClass}{CS336 Assignment \#5 (alignment)} % Course/class
...
\begin{questions}
    ...
    \titledquestion{Assignment Overreview}[0]
    \titledquestion{Reasoning with Language Models}[0]
    \input{q1.tex}
    \newpage
   \input{q2.tex}
    \newpage
